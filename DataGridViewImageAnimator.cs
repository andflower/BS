...
namespace BS
{
    public class AnimatedDataGridView : Guna2DataGridView
    {
        private DataGridViewImageAnimator _imageAnimator;
        public AnimatedDataGridView() : base()
        {
    ...
    public class DataGridViewImageAnimator
    {
        ...
        {
            private Guna2DataGridView Guna2DataGridView { get; set; }
            private HashSet<RowCol> _cells = new HashSet<RowCol>();

            public Image Image { get; set; }

            public AnimatedImage(Image image, Guna2DataGridView dataGridView)
            {
                Image = image;
            ...
            private void OnFrameChanged(object o, EventArgs e)
            {
                ...
                {
                    Guna2DataGridView.InvalidateCell(rc.Column, rc.Row);
                }
            }
        }
        ...
        public DataGridViewImageAnimator(Guna2DataGridView dataGridView)
        {
